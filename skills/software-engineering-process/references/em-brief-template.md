...
Use this template when briefing an EM agent for multi-phase implementation. The dedicated
issue owner fills in the placeholders and hands this to the EM as its brief.
