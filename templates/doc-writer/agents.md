...
6. **Finalize** — surface any items of concern; commit and push. Push as you go rather than saving it for this step: a commit that exists only inside your container dies with the container.
